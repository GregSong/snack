...
# 1 "/home/greg/Projects/cpp/snack/include/snack_types.h" 1
...
# 6 "/home/greg/Projects/cpp/snack/include/snack_types.h" 2
...
# 7 "option_impl.h" 2
# 1 "/home/greg/Projects/cpp/snack/include/snack_debug.h" 1
# 8 "option_impl.h" 2
...
namespace snack
{
    ...
    class Option
    {
        public:
            ...
            String& get_value(){return opt_value_;}
            Bool IsSet(){return opt_set_;}


            void set_opt_name(const String& str){opt_name_ = str;}
            void set_opt_abbreviation(const Char ab){opt_abbreviation_ = ab;}
            void set_opt_value(const String& v){opt_value_ = v;}
            void set_opt_set(Bool s){opt_set_ = s;}
        private:
            Option(){}
            ...
            String opt_value_;
            Bool opt_set_;
            String opt_default_value_;
            Bool opt_default_set_;
            String opt_desc;
    };
}
# 3 "option_impl.cc" 2
...
namespace snack
{
    Options::Option(const String& name,
            const Char abbr,
            const String& default_v,
            const String& desc="")
    {
    ...
    void OptionMgr::Parse(Strings& args, int argc, char** argv)
    {
        do{std::cout<<"option_impl.cc"<<":"<<32<<"\t->"<<__FUNCTION__<<std::endl;}while(0);
    }
}
